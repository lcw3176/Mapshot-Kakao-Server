package com.joebrooks.mapshotkakaoserver.Utils;
...
public class ChromeDrvierEX extends ChromeDriver {

    public ChromeDrvierEX() throws Exception {
        this(new ChromeOptions());
    }

    public ChromeDrvierEX(ChromeOptions options) throws Exception {
        this(ChromeDriverService.createDefaultService(), options);
    }

    public ChromeDrvierEX(ChromeDriverService service, ChromeOptions options) throws Exception {
